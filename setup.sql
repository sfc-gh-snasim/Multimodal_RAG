...
CREATE OR REPLACE STORAGE INTEGRATION TECHUP_MM_DOCS
  TYPE = EXTERNAL_STAGE
  STORAGE_PROVIDER = 'AZURE'
  ENABLED = TRUE
  AZURE_TENANT_ID = '10b954c6-0936-4436-9f16-e798bec7e808'
  STORAGE_ALLOWED_LOCATIONS = ('azure://nfcassetstg.blob.core.windows.net/tko/');

CREATE OR REPLACE STAGE MM_DOCS_EXT
  STORAGE_INTEGRATION = TECHUP_MM_DOCS
  URL = 'azure://nfcassetstg.blob.core.windows.net/tko/';
...
--   IMPORTS = ('@TECHUP25.MULTIMODAL_RAG.TECHUP_MULTIMODAL_RAG/branches/main/streamlit.txt')
  TITLE = 'Cortex Multimodal Search 🔎'
  QUERY_WAREHOUSE = TECHUP25_WH;